...
const PersonalityTestLinks: React.FC = () => {
  const testLinks = [
    ...
    {
      name: 'Test My Jungian Cognitive Functions',
  ...
  return (
    ...
    >
      <h3 className="text-lg font-medium text-gray-700 mb-6">
        Not sure about your personality type? Click the links below for free tests:
      </h3>
